...
| R10 | 取得 LINE OA #1-#8 預設模板後,與 gold 語料逐字比對,吻合者綁 OA #編號當鍵盤 v1 預設 | 5605/5606 |
...
- ~~Q1 #1-#8 OA 預設模板內容~~ → **已解(msg 5617,2026-09-21T14:42):Owner 親貼 #1-#5 全文**,正本+逐字比對存 oa_presets_v20260921.md。殘留:#6-#8 是否存在待 Owner 確認。比對結論:#1=語料 52 次模板現行版(5 處小改);#2 入厝/#5 外帶=前十查無屬新增;#3 婚禮/#4 企業=舊通用表單選項擴寫成專用版;現行 OA 已分眾化,語料=舊版發送紀錄。鍵盤 v1 正典=現行 #1-#5,語料當頻率證據與訓練底。
