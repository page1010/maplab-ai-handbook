window.HERMES_STATUS = {
  ...
  "reaction_cards": [
    ...
    },
    {
      ...
      "owner_role": "A0/B1",
      "target_task_card": "handoff/tasks/",
      "why": "10 active tasks have no activity for 7+ days: T-A1-V6-P2, T-A1-V7, T-A2-005-local-seo-factory, T-A2A3-001-B, T-A4-001, T-A4-003-photo-alt-pipeline.",
    ...
    "active": [
      {
        "task_id": "T-A5-005",
        "agent": "A5",
        "path": "handoff/tasks/T-A5-005.md",
        "status": "🔄 進行中",
        "last_activity": "2026-04-08",
        "days_ago": 75,
        "bucket": "active",
        "owner_related": false,
        "next_step": "程式碼已寫入 Code.gs（syncQuoteStatus_ / setupSyncTrigger / setupDashboard / ensureIntakeHeaders_）。下一步：clasp push → 手動啟動 trigger + Dashboard。",
        "blocker": "無（待 clasp push 部署）"
      },
      {
        "task_id": "T-A5-004",
        "agent": "A5",
      ...
      },
      {
        ...
        "status": "🔄 進行中（核心欄位已可用，業務可實際操作）",
        "last_activity": "2026-05-19（餐點毛利/食材占比與整體毛利分開顯示）",
        "days_ago": 34,
        "bucket": "active",
        "owner_related": true,
        "next_step": "核心公式已修正、e2e 通過。2026-05-19 已新增不改 master Sheet 的 A/B/C 副本產出接口，並修正 A5/A6 毛利口徑：優先看餐點毛利 / 食材成本佔比，整體毛利分開列。剩餘：T-A5-003 熱客招待品項定義 + 3 項待 Owner 確認",
        "blocker": "等 Owner 確認（品項名稱改法、重複品項、I 欄用途）"
      },
      {
