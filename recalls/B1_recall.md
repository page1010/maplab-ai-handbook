...
- 專案是否該暫停，而不是硬做完整系統。
- 若被召喚到 Investment OS / 財經幫手，能不能先帶入 Owner 的左側、右側、風控、籌碼與新聞判斷語言，而不是從頭教。
...
- 需要把 Owner 的 Investment OS 投資邏輯整理給其他 agent 使用。
...
6. skills/b1-innerflowlab-skills.md
7. docs/openclaw/output-contract.md
8. docs/openclaw/relation-graph.md
9. docs/openclaw/security-boundaries.md
