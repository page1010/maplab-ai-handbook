...
ROLES = [
    ...
    RoleModule(
        ...
        [
            ...
            "skills/media-limit-workaround.md",
            "skills/next-three-report.md",
            "skills/brand-voice-guide.md",
        ],
        ...
        startup_contract_extra=[
            "Treat local enhanced renders as review-only; final candidates must pass the A8 acceptance state machine.",
            "Do not upload unless a hash-bound receipt is at OWNER_VIDEO_GATE and the action is approved.",
        ],
