...
|---------|------|-----------|---------|------|
| T-A1-002 | Phase 4.1 系統治理升級（剩餘子任務②③④⑤⑦）| A1 | 子任務①⑥完成 | 🔄 進行中 |
...
| T-A3-001 | GTM LINE 按鈕追蹤修復（方案 B 執行）| A3 | 使用者確認 | ⏸️ 等使用者 |
...
| T-A4-001 | vision.py Phase 4 — Gemini 分析 + EXIF | A4 | 用戶確認相片來源 | ⏸️ 等使用者 |
| T-A3-002 | Canva C款素材上線 + Meta 策略一冷受眾 | A3 | 使用者完成素材 | ⏸️ 等使用者 |
