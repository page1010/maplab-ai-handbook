...
狀態：**ARCHIVED（Owner 裁決 2026-09-03 Q4：封存，擇需取用）**

> 本規格從未實作（Phase 1-4 腳本均不存在）。營收分析目標已由
> 「歷史 xlsx 考古＋品項裁決 Sheet＋毛利回推」路線承接
> （cdo reviews/QUOTE-ITEM-DB-20260903/）；報價主線收斂到 gym SOP v3.1
> （Hermes intake → Mina 人工填價）。需要客戶名冊/回購客等子目標時
> 從本文件擇段取用，不整套實作。裁決紀錄：cdo A5_DESIGN_REVIEW_20260903.md。
