# MAPLAB 音樂頻道企劃 v1.2（Suno + hermes 音樂風格資料庫 → YouTube 全自動日更）
建立：2026-09-09 | 開案：Owner msg 5045 | 維護：A0(Fable5) | 執行線：A8(音樂影音專屬)+hermes
狀態：v1.2——版權研究完成（Owner msg 5051），提案主軸改「chill聚餐 lounge × 公共財旋律改編」待 Owner 點頭後改版風格資料庫

## ▲、v1.2 版權研究與方向提案（Owner 5051「你先研究」，2026-09-09）

**Owner 提問**：對標婚禮歌手/童趣慶生/chill聚餐三選一（一個風格為主做微調）；AI 老歌新唱有無版權問題；挖版權到期的歌來唱可不可行。

### 三選一推薦：主風格=chill聚餐，婚禮/童趣=微調皮膚
日更頻道演算法吃一致性；chill 背景聆聽時長最長；婚禮版=同底聲弦樂化、童趣版=同底聲鐘琴化——三場景對應外燴三客群但聽感是同一頻道。

### AI 老歌新唱=有版權問題（法律結構）
- 一首歌兩層權利：**詞曲著作**（詞、曲各自有作者）+**錄音著作**。AI 重唱=新錄音，但詞曲著作未過期就需授權，與工具無關。
- 台灣保護期：著作財產權=作者死後 50 年；錄音著作=公開發表後 50 年。
- 附帶風險：AI 模仿特定歌手聲音→人格權爭議+YouTube AI 仿聲投訴下架機制+合成內容揭露義務。**禁做仿聲**。
- 正式授權（MUST/出版社）流程費用撐不起日更自動化→不走。

### 公共財（版權到期）方向=可行金礦，四個池子
| 池子 | 狀態 | 用法 |
|---|---|---|
| 鄧雨賢旋律（望春風/雨夜花/月夜愁/四季紅） | 曲：1944歿→1995 起公共財。**詞另計**：李臨秋1979歿→2029年底、周添旺1988歿→2038 | 純音樂 chill 改編合法零授權；不能唱原詞（可自寫新詞） |
| 傳統民謠（思想起/丟丟銅仔/天黑黑/桃花過渡） | 詞曲皆無主 | **能「唱」的池子**，AI 唱也合法 |
| 生日快樂歌旋律 | 公共財（2015 美國判決確立） | 童趣慶生線隨便改 |
| 西洋 1931 年前出版作品（1920s 爵士標準曲） | 美國公共財（95年制，2026 時點=1931 前） | chill聚餐線素材 |

### 兩個實務地雷
1. 只能從**原始旋律**自己編——現代人的編曲與錄音各有獨立著作權，不可抄、不可餵 Suno 現成錄音當 cover 源。
2. YouTube Content ID 對公共財曲目常有唱片公司誤宣告→需申訴，站得住腳但運營上耗時間，公開化後要留申訴 SOP。

### 待 Owner 圈選後的改版動作（未執行）
Owner 點頭「chill聚餐 × 台味公共財改編」主軸 → ①style-seeds CSV 改版（lounge 底聲＋公共財旋律清單欄）②20 首試聽清單改版 ③晨會 prompt 換新主軸。Suno 商用授權條款照舊在公開化前驗證。
