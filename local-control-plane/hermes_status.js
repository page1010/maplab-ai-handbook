window.HERMES_STATUS = {
  ...
  "generated_at": "2026-06-26T09:00:05+08:00",
  ...
  "signals": {
    ...
    "google_oauth_expired_seen": true,
    "owner_reauth_needed": true
  },
  "reaction_cards": [
    {
    ...
    },
    {
      ...
      "why": "5 blocked tasks are older than 14 days: T-A2-002-foodsafety-seo-cleanup, T-A2-005-local-seo-factory, T-A2A3-001, T-A3-002, T-A7-002.",
    ...
    },
    {
      ...
      "owner_role": "A0/B1",
      "target_task_card": "handoff/tasks/",
      "why": "10 active tasks have no activity for 7+ days: T-A1-LEARNING-LOOP-001, T-A1-V6-P2, T-A1-V7, T-A2A3-001-B, T-A4-001, T-A4-003-photo-alt-pipeline.",
  ...
  "buckets": {
    "blocked": [
      ...
      },
      {
        ...
        "status": "⏸️ 阻塞中",
        "last_activity": "2026-03-29 fb7ed48",
        "days_ago": 89,
        "bucket": "blocked",
        "owner_related": true,
        "next_step": "任務 6（Q1-Q10 實裝）+ 任務 10（技能書 v2.0）已完成。Phase 3A 剩任務 4（地區判斷）、7（流程圖同步）。Phase 3B/3C 全部待外部條件。",
        "blocker": "任務 1/2/3 需 LINE bot 後台權限；任務 9 需 Owner 政策決策（Q7 試吃 + Q10 取消改期）；任務 5/8 需 TimeTree 權限"
      },
      {
        ...
        "bucket": "blocked",
        "owner_related": true,
        "next_step": "Repo 端已清理完成；WordPress 端需 Owner 手動刪除/修改 5 篇文章的食安字眼",
        "blocker": "等 Owner 操作 WordPress 後台"
      },
      {
        "task_id": "T-A2-005-local-seo-factory",
        "agent": "A2",
        "path": "handoff/tasks/T-A2-005-local-seo-factory.md",
        "status": "⏸️ 暫停 (blocked-on-owner: 等 Owner 提供 WordPress Application Password; 非當前優先, 2026-06-25 by A0)",
        ...
        "blocker": "已有解法 — WP App Password 在 Notion 保管室, 依 skills/secrets-from-notion-vault.md runtime 取用建草稿(發布仍人工); 剩測試站檢核流程"
      },
      {
        "task_id": "T-A2A3-001",
        "agent": "A2",
    ...
    "active": [
      {
        ...
        "status": "🔄 進行中（核心功能已可用，Owner 可按「MAPLAB > 產出 Slide 提案」一鍵出簡報）",
        "last_activity": "2026-04-09 f67672d（6 項 Owner feedback 修復）",
        "days_ago": 78,
        "bucket": "active",
        "owner_related": true,
        "next_step": "Slide 可用。剩餘：品牌色票更新（CREAM/GOLD/DGOLD）、GAS 舊版檔案清理、Items english_name 確認",
        "blocker": "無（功能已上線，剩餘為優化項）"
      },
      {
        "task_id": "T-A4-001",
        "agent": "A4",
        "path": "handoff/tasks/T-A4-001.md",
        "status": "🔄 進行中（S11/2024 補跑執行中）",
        "last_activity": "2026-04-18 A0 確認進度 + Colab 重啟（S11 補跑 82.2%）",
        "days_ago": 69,
        "bucket": "active",
        "owner_related": true,
        "next_step": "S11(2024) 🔄 補跑中，10,050/12,213（82.2%），TODO=2,163，Colab 已重啟等授權",
        "blocker": "無（S11 補跑已重啟，等 Google 憑證授權後自動開始）"
      },
      {
        "task_id": "T-A1-V6-P2",
        "agent": "A1",
        "path": "handoff/tasks/T-A1-V6-P2.md",
        "status": "🔄 進行中",
        "last_activity": "2026-04-19 08170b7",
        "days_ago": 68,
        "bucket": "active",
        "owner_related": false,
        "next_step": "4 分頁架構 + DropdownHelper 驗證完成、REVISION_LOG 精簡完成。下一步：建虛擬測試案例 → A6 跑報價流程 → 驗證寫入。",
        "blocker": "等 A6 實際報價測試"
      },
      {
        "task_id": "T-A1-V7",
        "agent": "A1",
        "path": "handoff/tasks/T-A1-V7.md",
        "status": "🔄 進行中",
        "last_activity": "2026-04-19 08170b7",
        "days_ago": 68,
        "bucket": "active",
        "owner_related": false,
        "next_step": "Phase 1-4 全部完成 + 6 個修復項全部完成。剩 Phase 5（自動壓縮 ReMe）為加分項。",
        "blocker": "無"
      },
      {
    ...
    "unmarked": [
      ...
      {
        "task_id": "T-IOS-KOL-001",
        "agent": "IOS-KOL",
        "path": "handoff/tasks/T-IOS-KOL-001.md",
        "status": "未標記",
        "last_activity": "未知",
        "days_ago": null,
        "bucket": "unmarked",
    ...
    "paused": [
      {
        ...
        "status": "🔄 進行中 (2026-06-25 解除暫停: 6/22 LINE OA 雙向匯出 3,625 CSV 已補齊業務回覆側; pipeline+scaffold+150配對已在 workbook/a6-training/)",
        "last_activity": "2026-04-07",
        "days_ago": 80,
        "bucket": "paused",
        "owner_related": true,
  ...
  "raw_patrol_excerpt": "📋 每日自動巡查 — 2026-06-26 09:00\n\n=== MAPLAB 系統巡查 2026-06-26 09:00 ===\n\n[🔴 EXPIRED] Google OAuth token — auto-refreshing...\n✅ Token refreshed, new expiry: 2026-06-26T02:00:04.561405+00:00\n\n【Owner 行動項】\n  → T-A2-002-foodsafety-seo-cleanup: 等 Owner 操作 WordPress 後台\n  → T-A2A3-001: RM/GSC 驗證需 Owner/A1 另開；目前不可把舊 planned slug 當 live URL\n  → T-A3-002: 執行需登入 Meta Ads Manager（等廣告週期 + Owner 操作）\n  → T-A7-002: 任務 1/2/3 需 LINE bot 後台權限；任務 9 需 Owner 政策決策（Q7 試吃 + Q10 取消改期）；任務 5/8 需 TimeTree 權限\n\n【阻塞中 — 等外部條件】\n  ⏸️ T-A2-002-foodsafety-seo-cleanup (A2): 等 Owner 操作 WordPress 後台 [80d ago]\n  ⏸️ T-A2-005-local-seo-factory (A2): 已有解法 — WP App Password 在 Notion 保管室, 依 skills/secrets-from-notion-vault.md runtime 取用建草稿(發布仍人工); 剩測試站檢核流程 [53d ago]\n  ⏸️ T-A2A3-001 (A2): RM/GSC 驗證需 Owner/A1 另開；目前不可把舊 planned slug 當 live URL [33d ago]\n  ⏸️ T-A3-002 (A3): 執行需登入 Meta Ads Manager（等廣告週期 + Owner 操作） [89d ago]\n  ⏸️ T-A7-002 (A7): 任務 1/2/3 需 LINE bot 後台權限；任務 9 需 Owner 政策決策（Q7 試吃 + Q10 取消改期）；任務 5/8 需 TimeTree 權限 [88d ago]\n\n【進行中】\n  ❓ T-A1-EXT-001-dynamic-role-modules (A1): 狀態未標記 [日期不明]\n  ⚠️ T-A1-LEARNING-LOOP-001 (A1): 建立 token capital registry，登記可複用 prompt / eval / task packet / sk [10d ago]\n  ❓ T-A1-RTK-001 (A1): 狀態未標記 [日期不明]\n  ⚠️ T-A1-V6-P2 (A1): 4 分頁架構 + DropdownHelper 驗證完成、REVISION_LOG 精簡完成。下?? [68d ago]\n  ⚠️ T-A1-V7 (A1): Phase 1-4 全部完成 + 6 個修復項全部完成。剩 Phase 5（自動壓縮 [68d ago]\n  ❓ T-A2-006-ads-seo-wordpress-patrol (A2): 狀態未標記 [日期不明]\n  ❓ T-A2-SEO-CATERING-MATRIX-001 (A2): 狀態未標記 [日期不明]\n  ⚠️ T-A2A3-001-B (A2): WordPress post `1696` 已建立為未發布草稿並重載驗證：`https://www. [30d ago]\n  ⚠️ T-A4-001 (A4): S11(2024) 🔄 補跑中，10,050/12,213（82.2%），TODO=2,163，Colab 已重? [69d ago]\n  ❓ T-A4-002 (A4): 狀態未標記 [日期不明]\n  ⚠️ T-A4-003-photo-alt-pipeline (A4): 等 36,676 張處理完 → Owner 改 Drive 串流 → 釋出 ~433GB [14d ago]\n  ⚠️ T-A4-004-photo-classify (A4): 批次跑完後 `--status` 查進度，續開下一批直到 ~98,400 張完成 [14d ago]\n  ⚠️ T-A5-002 (A5): Owner 三題已回答（2026-06-23）→ 已加 `fixMasterTemplate_()` 到 Code. [2d ago]\n  ⚠️ T-A5-004 (A5): Slide 可用。剩餘：品牌色票更新（CREAM/GOLD/DGOLD）、GAS 舊版檔 [77d ago]\n  ⚠️ T-A5-005 (A5): `clasp push --force` 已成功部署 8 檔（含 syncQuoteStatus_ / setupSyncTri [2d ago]\n  ⚠️ T-A6-001 (A6): Case Store v0 已接到現有 `CONVERSATION_LOG`；A6 Telegram 新增 `/linecase [7d ago]\n  ❓ T-A8-001-folder-to-video-distribution (A8): 狀態未標記 [日期不明]\n  ⚠️ T-B1-B4-investment-os-role-split (??): B1-B4 已不只做角色拆分；新增 RSI-like 成長閉環，下一步是把  [7d ago]\n  ❓ T-B1-DASH-001 (??): 狀態未標記 [日期不明]\n  ❓ T-HQ-001 (??): 狀態未標記 [1d ago]\n  ⚠️ T-IOS-KOL-001 (??): - **接續點**：四個每日時段（02:30/08:30/14:30/21:20）的 Telegram di [5d ago]\n\n【暫停/待開始】\n  🔲 T-A1-SYNC-GUARD-001 (A1): 待開始\n  🔲 T-A1-V6-P3 (A1): 待開始\n  🔲 T-A2-003-weekly-wp-audit (A2): 待開始\n  🔲 T-A2-004 (A2): 待開始\n  🔲 T-A5-006 (A5): 待開始\n  💤 T-A6-002 (A6): 暫停中 [79d ago]\n  💤 T-A7-001 (A7): 暫停中 [89d ago]\n  💤 T-B1-001 (??): 暫停中 [日期不明]\n  🔲 T-GBP-001 (??): 待開始\n\n【已完成】6 張 Task Card\n",
  "reaction_ledger": {
