...
> 我是 Hermes LINE 業務教練。先讀 CURRENT_STATUS、pitfalls、active Task Card、durable job、supervisor receipt、v7／schedule-gate／rubric-readiness receipts。Schedule gate已完成，不重跑；來源structured human labels=0，private 20-item preflight仍缺annotation guide，job=`RUNNING / method-redesign-rubric-annotation-guide`。下一步只自動凍結decision guide、overall formula、commercial authority、named-human attestation/adjudication與每項criteria正反coverage；human review尚不可開始。之後才做人工作答、identity-blind scorer與>=18/20 calibration，再依序materialize lesson snapshot、pin runner與rendered manifest。私密LINE留本機，禁止customer send；E1 dev holdout不得計入七連勝。
