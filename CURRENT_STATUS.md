...
| T-A4-001 | Phase 4 Gemini 照片分類（2022-2026） | A4 | 🔴 CRITICAL（S11 卡在 82.2%，Colab 兩次斷線後 ~80 天無人接手；Owner 2026-07-06 已授權修好重啟，A1 評估見 Task Card，建議改走本機 Ollama vision 路徑不要用回頭 Gemini API key） | handoff/tasks/T-A4-001.md |
...
| A4 | T-A4-001: S11(2024) 卡在 82.2%（差 2,163 張），Colab 兩次斷線後 ~80 天無人回去繼續。Owner 2026-07-06 已授權修好重啟；A1 評估建議改走本機 Ollama vision 路徑（比照 T-A4-004），不要走回頭用同一把可能已停用額度的 Gemini API key | 見 Task Card「2026-07-06 A1 重啟評估」 |
