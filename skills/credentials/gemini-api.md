...
版本：v1.1 | 建立：2026-03-29 | 維護者：A1 | 更新：2026-04-18

⚠️ 2026-04-18 發現：maplab-pipeline 的 Gemini API key 綁定 GCP billing，超過免費額度會自動收費。3-4 月累計產生 ~$3,000 TWD。需要改用不綁 billing 的 key 或設定預算上限。
