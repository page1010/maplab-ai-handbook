...
奇美醫院、中興工程、大台南會展中心、興富發。

**去重查證（2026-09-09 網路查核）：科林研發＝Lam Research 1992 年設立的台灣
子公司（美商科林研發），logo 同 Lam Research——現牆已有 Lam Research，
自動歸併不重上。** 淨新增＝13 家。備選不上維持原判（建設類現牆已多；
三立/訊聯/璟馨全名未核實）。
...
| 大台南會展中心 | https://www.icctainan.com/ | svg(inline) | header 為內嵌 data-URI SVG，從頁面原始碼抽 |
...
1. **主視窗/win-01（需瀏覽器）**：照 §二 來源表抓 13 家彩色原檔落
   data/vendor-db/logos/（富邦/中興/興富發/ICC 四家必須瀏覽器）；現牆
