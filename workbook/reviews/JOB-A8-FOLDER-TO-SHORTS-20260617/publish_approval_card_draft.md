# A8 Publish Approval Card Draft
...
- Asset folder: `workbook/reviews/JOB-A2A3A4-APPROVAL-READY-20260615-ICCTAINAN/wordpress_assets_icctn_001/`
- Public-safe case label: `大臺南會展中心企業會議茶點`
- Related landing page: `https://www.maplabkitchen.com/icc-tainan-catering/`
...
1. Approve final asset production only; no upload.
2. Approve YouTube Shorts upload only.
3. Approve TikTok upload only.
4. Approve YouTube + TikTok + Pinterest.
5. Return for edits.
