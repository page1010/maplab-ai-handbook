...
| T-A2A3-001 | SEO 關鍵字頁面補足（Focus Keyword修正 + Landing Page + 內連結） | A2/A3 | 無 | 🔄 進行中（子任務1 Focus Keyword盤點） | handoff/tasks/T-A2A3-001.md |
| T-A2A3-001-B | SEO 場景頁面 + 內連結（從T-A2A3-001分拆：子任務3+4+5） | A2 | T-A2A3-001子任務1完成 | 🔲 待開始 | handoff/tasks/T-A2A3-001-B.md |
