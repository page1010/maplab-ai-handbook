...
Telegram 派工 ID: TG-DISPATCH-20260821-185312-ads-performance-review
任務類型: 投放成效判讀任務
主責/協作: A3, A2, A1
...
## Owner 原始指令
```text
做1 你們session這樣控管很不好，我是不是要接一個專用telegram bot 給fable5當主管 像為什麼你A1背後底層模型沒有預設高一點再去召喚其他依照需求做事安排子session
```
