window.HERMES_STATUS = {
  ...
  "generated_at": "2026-07-17T09:00:05+08:00",
  ...
  "buckets": {
    "blocked": [
      ...
      },
      {
        "task_id": "T-A7-001",
        "agent": "A7",
        "path": "handoff/tasks/T-A7-001.md",
        "status": "🔄 進行中（模板庫完整，Phase 3 上線測試 NOW-ready，唯一技術阻塞：A5 外送費 Q5 自動計算）",
        "last_activity": "2026-07-11（A1 — ai-reply-system.md SECTION 8 同步更新：Q7 路徑改「直接告知不提供試吃」；補 Q10 回頭客/B2B 路徑；補取消/改期觸發點）",
        "days_ago": 6,
        "bucket": "blocked",
        "owner_related": true,
        "next_step": "模板庫 + SECTION 8 全部對齊 Owner 政策；Phase 3 = Mina 開始用 `data/a7-reply-templates.md` 接真實 LINE 對話，Owner 授權後立即可啟動",
        "blocker": "A5 外送費級距未建立（僅影響 Q5 自動計算；手動模板不受影響）"
      }
    ],
    "active": [
      {
      ...
      },
      {
        ...
        "blocker": "WP 寫入憑證需 Owner 確認（路徑：`skills/credentials/wordpress-api.md`）"
      },
      {
        ...
        "bucket": "active",
        "owner_related": true,
        "next_step": "任務已建立，Owner 要求 A8 從「閒置」轉為真實內容產線；IG Reel 底層邏輯研究 + 流程技能書尚未完成。",
        "blocker": "無（可自主執行）"
      },
      {
    ...
    "unmarked": [
      ...
      },
      {
        ...
        "bucket": "unmarked",
        "owner_related": true,
        "next_step": "ICCTN 案例文（post 1829）已上線，QA PASS_WITH_NOTES。下一步：A3 接手 Google Ads final URL + 受眾與否定字驗收；可補第 6 張以上圖片。",
        "blocker": "Meta/Google MCP token 過期，需 Owner 重授權。"
      },
      {
        "task_id": "T-B1-DASH-001",
        "agent": "B1",
        "path": "handoff/tasks/T-B1-DASH-001.md",
        "status": "🟢 READY（已派工，等 Codex 執行）",
        "last_activity": "2026-06-20",
        "days_ago": 27,
        "bucket": "unmarked",
        "owner_related": false,
        "next_step": "Game dashboard v0.2 完成（9 NPC / 6 rooms / 21 cards，驗收通過）。尚未完成：registry generator、`ops_board_status.json`、全 21 部門 NPC 鋪圖。",
        "blocker": "無"
      },
      {
  ...
  "raw_patrol_excerpt": "📋 每日自動巡查 — 2026-07-17 09:00\n\n=== MAPLAB 系統巡查 2026-07-17 09:00 ===\n\n[🔴 EXPIRED] Google OAuth token — auto-refreshing...\n✅ Token refreshed, new expiry: 2026-07-17T02:00:04.660718+00:00\n\n【Owner 行動項】\n  → T-A2-002-foodsafety-seo-cleanup: 等 Owner 決定 post 698 的「無麩質或低糖選項」FAQ 答案要不要改（A2 唯讀掃描，未動任何文章）\n  → T-A2A3-001: RM/GSC 驗證需 Owner/A1 另開；目前不可把舊 planned slug 當 live URL\n  → T-A3-002: 執行需登入 Meta Ads Manager（等廣告週期 + Owner 操作）\n\n【阻塞中 — 等外部條件】\n  ⏸️ T-A2-002-foodsafety-seo-cleanup (A2): 等 Owner 決定 post 698 的「無麩質或低糖選項」FAQ 答案要不要改（A2 唯讀掃描，未動任何文章） [10d ago]\n  ⏸️ T-A2A3-001 (A2): RM/GSC 驗證需 Owner/A1 另開；目前不可把舊 planned slug 當 live URL [54d ago]\n  ⏸️ T-A3-002 (A3): 執行需登入 Meta Ads Manager（等廣告週期 + Owner 操作） [110d ago]\n  ⏸️ T-A7-001 (A7): A5 外送費級距未建立（僅影響 Q5 自動計算；手動模板不受影響） [5d ago]\n  ⏸️ T-A7-002 (A7): 任務 1/2/3 需 LINE bot 後台權限；任務 5/8 需 TimeTree 權限（任務 9 已解除） [10d ago]\n\n【進行中】\n  ⏳ T-A1-EXT-001-dynamic-role-modules (A1): （checkpoint.sh 自動補建，請 agent 填寫） [1d ago]\n  ⏳ T-A1-LEARNING-LOOP-001 (A1): 建立 token capital registry，登記可複用 prompt / eval / task packet / sk [1d ago]\n  ❓ T-A1-RTK-001 (A1): 狀態未標記 [47d ago]\n  ⏳ T-A1-V6-P2 (A1): 4 分頁架構 + DropdownHelper 驗證完成、REVISION_LOG 精簡完成。下?? [1d ago]\n  ⏳ T-A1-V7 (A1): Phase 1-4 全部完成 + 6 個修復項全部完成。剩 Phase 5（自動壓縮 [1d ago]\n  ⚠️ T-A2-005-local-seo-factory (A2): 本地 SEO Factory 骨架已建（Planner→Auditor 七階段）、三大 Pillar [74d ago]\n  ❓ T-A2-006-ads-seo-wordpress-patrol (A2): 狀態未標記 [32d ago]\n  ⚠️ T-A2-SEO-CATERING-MATRIX-001 (A2): 競品分析工作包已建立於 `workbook/reviews/JOB-A2-SEO-CATERING-COMPETIT [30d ago]\n  ⚠️ T-A2A3-001-B (A2): WordPress post `1696` 已建立為未發布草稿並重載驗證：`https://www. [51d ago]\n  ⚠️ T-A4-002 (A4): 187GB Takeout（5 個 ZIP）確認存在 Drive，尚未解壓；解壓 + 分類  [90d ago]\n  ⚠️ T-A4-003-photo-alt-pipeline (A4): 等 36,676 張處理完 → Owner 改 Drive 串流 → 釋出 ~433GB [35d ago]\n  ⚠️ T-A4-004-photo-classify (A4): 批次跑完後 `--status` 查進度，續開下一批直到 ~98,400 張完成 [35d ago]\n  ⚠️ T-A5-002 (A5): Owner 三題已回答（2026-06-23）→ 已加 `fixMasterTemplate_()` 到 Code. [23d ago]\n  ❓ T-A5-004 (A5): 狀態未標記 [98d ago]\n  ⚠️ T-A5-005 (A5): `clasp push --force` 已成功部署 8 檔（含 syncQuoteStatus_ / setupSyncTri [23d ago]\n  ⚠️ T-A6-001 (A6): Case Store v0 已接到現有 `CONVERSATION_LOG`；A6 Telegram 新增 `/linecase [8d ago]\n  ⚠️ T-A8-001-folder-to-video-distribution (A8): 任務已建立，Owner 要求 A8 從「閒置」轉為真實內容產線；IG R [29d ago]\n  ❓ T-B1-001 (??): 狀態未標記 [56d ago]\n  ⚠️ T-B1-B4-investment-os-role-split (??): B1-B4 已不只做角色拆分；新增 RSI-like 成長閉環，下一步是把  [28d ago]\n  ❓ T-B1-DASH-001 (??): 狀態未標記 [26d ago]\n  ❓ T-HQ-001 (??): 狀態未標記 [22d ago]\n  ⚠️ T-IOS-KOL-001 (??): - **接續點**：四個每日時段（02:30/08:30/14:30/21:20）的 Telegram di [26d ago]\n\n【暫停/待開始】\n  🔲 T-A1-SYNC-GUARD-001 (A1): 待開始\n  🔲 T-A1-V6-P3 (A1): 待開始\n  🔲 T-A2-003-weekly-wp-audit (A2): 待開始\n  🔲 T-A2-004 (A2): 待開始\n  🔲 T-A5-006 (A5): 待開始\n  🔲 T-A5-007-codex-takeover (A5): 待開始\n  💤 T-A6-002 (A6): 暫停中 [100d ago]\n  🔲 T-GBP-001 (??): 待開始\n\n【已完成】8 張 Task Card\n  （最近異動 3 張，其餘見 handoff/tasks/）\n  ✅ T-A4-001\n  ✅ T-A2-007-seo-trio-review-20260707\n  ✅ T-A2-001\n\n【投資 OS 守夜人】\n🟢 nightwatch 今日正常（今日報告已產生，0 警示）\n",
  "reaction_ledger": {
